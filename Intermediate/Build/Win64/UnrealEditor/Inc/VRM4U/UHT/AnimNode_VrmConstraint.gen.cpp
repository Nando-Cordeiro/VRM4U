...
template<> VRM4U_API UScriptStruct* StaticStruct<FAnimNode_VrmConstraint>()
{
	...
	struct Z_CompiledInDeferFile_FID_VRM4U_Plugin_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmConstraint_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VRM4U_Plugin_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmConstraint_h_Statics::ScriptStructInfo[] = {
		{ FAnimNode_VrmConstraint::StaticStruct, Z_Construct_UScriptStruct_FAnimNode_VrmConstraint_Statics::NewStructOps, TEXT("AnimNode_VrmConstraint"), &Z_Registration_Info_UScriptStruct_AnimNode_VrmConstraint, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAnimNode_VrmConstraint), 938821841U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VRM4U_Plugin_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmConstraint_h_1808503927(TEXT("/Script/VRM4U"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_VRM4U_Plugin_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmConstraint_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VRM4U_Plugin_Plugins_VRM4U_Source_VRM4U_Public_AnimNode_VrmConstraint_h_Statics::ScriptStructInfo),
		nullptr, 0);
